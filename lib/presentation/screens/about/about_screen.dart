      ...
      body: ListView(
        ...
        children: [
          ...
          _Section(
            ...
            child: Column(children: [
              _ContactTile(
                ...
                label: 'Email',
                valeur: SettingsService.instance.supportEmail ?? 'contact@akdev.ci',
                couleur: AppColors.primary,
                isDark: isDark,
                onTap: () => _ouvrir('mailto:${SettingsService.instance.supportEmail ?? 'contact@akdev.ci'}'),
              ),
              Divider(height: 1, color: isDark ? AppColors.white12 : AppColors.surfaceAlt),
              _ContactTile(
                icone: Icons.language_rounded,
                label: 'Site web',
                valeur: 'daoukro.akdev.ci',
                couleur: AppColors.primary,
                isDark: isDark,
                onTap: () => _ouvrir('https://daoukro.akdev.ci'),
              ),
            ]),
          ),
          const SizedBox(height: 16),
          ...
          _Section(
            ...
            textSec: textSec,
            child: Column(children: [
              _LegalTile(label: 'Développé par', valeur: 'AKDEV.CI', textSec: textSec),
              Divider(height: 1, color: isDark ? AppColors.white12 : AppColors.surfaceAlt),
